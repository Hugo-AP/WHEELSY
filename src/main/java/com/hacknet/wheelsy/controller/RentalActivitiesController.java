...
@RestController
@RequestMapping("/api")
public class RentalActivitiesController {
    @Autowired
    ...
    @PostMapping("/users/{user_id}/entrepreneurs/{entrepreneurId}")
    public UserResource assignSubscribe(
        ...
        return convertToResource(userService.assignMaintenance(user_id, entrepreneurId));
    }

    @DeleteMapping("/users/{user_id}/entrepreneurs/{entrepreneurId}")
    public UserResource unAssignSubscribe(
            @PathVariable(name = "user_id") Long user_id,
            @PathVariable(name = "entrepreneurId") Long entrepreneurId) {
        return convertToResource(userService.unassignMaintenance(user_id, entrepreneurId));
    }
